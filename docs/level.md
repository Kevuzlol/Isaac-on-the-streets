...
`DynamicScene`, to the `com.github.hanyaeger.Isaac_on_the_streets.scenes`
...
`com.github.hanyaeger.Isaac_on_the_streets.entities.buttons`. Use the following constructor:
