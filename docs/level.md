...
`DynamicScene`, to the `com.github.hanyaeger.isaaconthestreets.scenes`
...
`com.github.hanyaeger.isaaconthestreets.entities.buttons`. Use the following constructor:
