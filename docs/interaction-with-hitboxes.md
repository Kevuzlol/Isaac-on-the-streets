...
`com.github.hanyaeger.Isaac_on_the_streets.entities.swordfish`. In this package create a
...
`com.github.hanyaeger.Isaac_on_the_streets.entities.swordfish` in the following way:
