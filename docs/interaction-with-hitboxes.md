...
`com.github.hanyaeger.isaaconthestreets.entities.swordfish`. In this package create a
...
`com.github.hanyaeger.isaaconthestreets.entities.swordfish` in the following way:
